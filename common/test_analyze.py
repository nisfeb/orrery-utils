...
class Association(unittest.TestCase):
    ...
    def test_a_one_word_name_prefers_the_exact_body(self):
        context = {'bodies': [{'id': 'person/me', 'name': 'jackson', 'aliases': []},
                              {'id': 'person/x', 'name': 'jackson wife', 'aliases': []}]}
        self.assertEqual(analyze.existing_for({'id': 'person/jackson-2', 'name': 'jackson'}, context, []), 'person/me')
        self.assertIsNone(analyze.existing_for({'id': 'person/j', 'name': 'jackson egan'}, context, []))
