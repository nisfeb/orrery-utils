...
A calendar title often names who the event is for: "Adelaide- Ballet/Tap" and "Rose and Linus- Opti Sail" name participants, "Magnus Birthday" names Magnus. Resolve the name against the people listed; when nobody by that name exists, create the person (first name as the body's name) and add them as a participant of the activity or situation. A production or a place name is not a person: "Nutcracker rehearsal" names no one.
